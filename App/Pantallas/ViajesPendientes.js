            ...
            <View  style = {{flex:1, backgroundColor: COLORES.BACKGROUND}}>
                ...
                <View style = {{flex:1, marginLeft:30, marginRight:30}}>
                    ...
                    <ScrollView showsVerticalScrollIndicator={false} style = {{flex:1}}>
                        ...
                        <CartaPequenniaComponente mostrarBoton = {true} color  = {COLORES.ROJO} titulo = "San José - TEC" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
                        <CartaPequenniaComponente mostrarBoton = {true      } color  = {COLORES.VERDE} titulo = "TEC - Heredia" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
                        <CartaPequenniaComponente mostrarBoton = {true} color  = {COLORES.ROJO} titulo = "San José - TEC" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
                        <CartaPequenniaComponente mostrarBoton = {true      } color  = {COLORES.VERDE} titulo = "TEC - Heredia" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
                        <CartaPequenniaComponente mostrarBoton = {true} color  = {COLORES.ROJO} titulo = "San José - TEC" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
                        <CartaPequenniaComponente mostrarBoton = {true      } color  = {COLORES.VERDE} titulo = "TEC - Heredia" detalle = "19/10/2017 - 11:30am" imagen = "Mapa"></CartaPequenniaComponente>
