            ...
            <View  style = {{flex:1, backgroundColor: COLORES.BACKGROUND}}>
                ...
                <View style = {{flex:1, marginLeft:30, marginRight:30, marginTop: 30, marginBottom:30}}>
                    <ScrollView showsVerticalScrollIndicator={false} style = {{flex:1}}>
                        <CartaPequenniaComponente boton_onPress = {()=>{this._cancelarViajePendiente(12)}} boton_activo = {true} boton_mt = {3} boton_mb = {3} boton_mr = {5} boton_filled = {require('../Imagenes/pendiente.gif')} boton_unfilled = {require('../Imagenes/pendiente.gif')} boton_width = {40} boton_height = {10} imagen = {require('../Imagenes/map.png')} mostrarBoton = {true} color  = {COLORES.ROJO} titulo = "San José - TEC" detalle = "19/10/2017 - 11:30am" ></CartaPequenniaComponente>
